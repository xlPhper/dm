...
class OpenBase extends DM_Controller
{
    const STATUS_OK = 1;
    const STATUS_FAIL = 0;
...
//            $this->showJson(0, '无权访问');
    ...
    {
        $this->adminWxIds = Model_Weixin::getInstance()->getWxIdsByYyAdminId($this->getLoginUserId());
    }
     ...
     * 获取同部门的管理员
     */
    public function getDepartmentAdminIds()
    {
       return Model_Role_Admin::getInstance()->getDepartmentAdminIds($this->getLoginUserId());
    }
